...
let cc = Config.sessionName.replace(/MR-KALINDU;;;/g, "").replace(/BLACK;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
